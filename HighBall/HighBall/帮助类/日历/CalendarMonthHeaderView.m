...
#define CATDayLabelWidth  (self.frame.size.width-80)/7
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake((self.frame.size.width-300)/2, 10.0f, 300.0f, 30.f)];
    ...
    xOffset += CATDayLabelWidth + 10.0f;
