...
- (IBAction)rule:(id)sender {
    ...
    JKAlertDialog *alert=[[JKAlertDialog alloc]initWithTitle:@"订单规则" message:@"" color:color andBoolen:YES];
...
- (IBAction)delegate:(id)sender {
    ...
    JKAlertDialog *alert=[[JKAlertDialog alloc]initWithTitle:@"协议" message:@"" color:color andBoolen:YES];
...
- (IBAction)payAction:(id)sender {
    ...
    UIColor *color=[UIColor colorWithRed:0.0/255 green:136.0/255 blue:254.0/255 alpha:1];
    JKAlertDialog *alert=[[JKAlertDialog alloc]initWithTitle:@"订单支付" message:@"" color:color andBoolen:YES];
    ...
    if(/* DISABLES CODE */ (YES)){
        [BallSpellAPI sendOrdergolfCourseID:self.courseID andBookDate:self.date andBookTime:self.time andUserID:@"3" andNumberOFGroups:self.numberPerson andTotalPrice:self.price andCallback:^(id obj) {
            ...
            if (orderID!=nil) {
                ...
                UIColor *color=[UIColor colorWithRed:0.0/255 green:136.0/255 blue:254.0/255 alpha:1];
                JKAlertDialog *alert=[[JKAlertDialog alloc]initWithTitle:@"温馨提示" message:@"" color:color andBoolen:NO];
