...
- (IBAction)BunkButton:(UIButton *)sender {
    ...
    JKAlertDialog *alert = [[JKAlertDialog alloc]initWithTitle:self.airName message:@"" color:color andBoolen:NO];
...
- (IBAction)passenger:(UIButton *)sender {
    self.airName = @"乘客选择";
    UIColor *color = [UIColor blueColor];
    JKAlertDialog *alerts = [[JKAlertDialog alloc]initWithTitle:self.airName message:@"" color:color andBoolen:NO];
